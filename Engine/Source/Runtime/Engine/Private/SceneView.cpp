...
FSceneView::FSceneView(const FSceneViewInitOptions& InitOptions)
	...
	, VRProjMode(EVRProjectMode::Planar) // LaviniaADD 
	, bVRProjectEnabled(false)
	, NonVRProjectViewRect(ViewRect)
	, MultiResConf(FMultiRes::Configuration_Vive_Aggressive)
	, LensMatchedShadingConf(FLensMatchedShading::Configuration_Vive_Aggressive)
...
{	
	...
	bShouldBindInstancedViewUB = bIsInstancedStereoEnabled || bIsMobileMultiViewEnabled; /* Lavinia : wondering in SPS should be included here too*/
